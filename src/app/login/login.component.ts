                  ...
                  <div class="col-md-6">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <button (click)="fillAdminCredentials()" class="btn btn-sm btn-outline-primary w-100">
                          Use Admin
                        </button>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <button (click)="fillUserCredentials()" class="btn btn-sm btn-outline-primary w-100">
                          Use User
                        </button>
                      </div>
                    </div>
